        ...
        <div className="content">
          ...
          <div className="container">
            <div className="row mt-4">
              <p className="display-6 fw-bold">RELATED PRODUCTS</p>
              <hr />
            </div>
            <div className="row">
                ...
                <div className="col-lg-2 col-sm-6">
                  <div className="cards">
                    <img src={product.img} className="card-img-top imghover" alt="" />
                    {/* <img src={product.hoverSrc} className="imagehover card-img-top" alt="" /> */}
                    <div className="card-hover-icon">
                      <a href="#">
                        <i className="ion ion-cart mt-3"></i>
                      </a>
                      <a href="#">
                        <i className="ion ion-heart mt-3"></i>
                      </a>
                      <button data-bs-target="#Modalpro" data-bs-toggle="modal">
                        <i className="ion ion-search mt-3"></i>
                      </button>
                    </div>
                    <div className="card-body">
                      ...
                      <span className="text-secondary text-decoration-line-through fw-light">201</span>
                    </div>
                  </div>
                </div>
